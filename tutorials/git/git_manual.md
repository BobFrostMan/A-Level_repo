...
![create new repository](https://github.com/BobFrostMan/A-Level_repo/blob/master/tutorials/resources/git_manual/1_create_repo.jpg)
...
![copy link](https://github.com/BobFrostMan/A-Level_repo/blob/master/tutorials/resources/git_manual/2_copy_link.jpg)
...
![open bash here](https://github.com/BobFrostMan/A-Level_repo/blob/master/tutorials/resources/git_manual/3_open_bash_here.jpg)
...
```
![git clone](https://github.com/BobFrostMan/A-Level_repo/blob/master/tutorials/resources/git_manual/4_git_clone.jpg)

6. В папке с локальным репозиторием? необходимо создать новый проект используя intelij idea.
![open project](https://github.com/BobFrostMan/A-Level_repo/blob/master/tutorials/resources/git_manual/5_open_project.jpg)

7. В корне проекта необходимо создать файл с именем **.gitignore**, как показано на скриншоте:
![create gitignore](https://github.com/BobFrostMan/A-Level_repo/blob/master/tutorials/resources/git_manual/6_create_gitignore.jpg)
...
![git add git status](https://github.com/BobFrostMan/A-Level_repo/blob/master/tutorials/resources/git_manual/7_git_add_git_status.jpg)
...
![git commit git push](https://github.com/BobFrostMan/A-Level_repo/blob/master/tutorials/resources/git_manual/8_git_commit_git_push.jpg)
```
